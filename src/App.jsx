  ...
  return (
    <main>
      ...
      <section className="story">
        ...
        <p>מי שתופס כאן שטח פרסום לא סתם מפרסם — הוא תופס עמדה בתמונה שכולם יסתכלו עליה. כאן אין קטנים וגדולים: כל מי שבפנים הוא כוכב, וכל שטח הוא במה. וכשקטגוריה מגיעה למיליון — היא מלאה ונסגרת. מי שבפנים, בפנים. מי שמחכה — ימצא את המקום תפוס.</p>
